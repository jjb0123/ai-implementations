...
test2_explanation = [
  ...
  [
    {
      "name": "(grandmotherof ada chen)",
      "asserted": False,
      "support": [
        {
          "fact": {
            "name": "(motherof ada bing)",
            "asserted": True,
            "support": None
          },
          "rule": {
            "name": "((motherof ?z bing)) -> (grandmotherof ?z chen)",
            "asserted": False,
            "support": [
              {
                "fact": {
                  "name": "(parentof bing chen)",
                  "asserted": False,
                  "support": [
                    {
                      "fact": {
                        "name": "(motherof bing chen)",
                        "asserted": True,
                        "support": None
                      },
                      "rule": {
                        "name": "((motherof ?x ?y)) -> (parentof ?x ?y)",
                        "asserted": True,
                        "support": None
                      }
                    }
                ...
                "rule": {
                  "name": "((parentof ?x ?y) (motherof ?z ?x)) -> (grandmotherof ?z ?y)",
                  "asserted": True,
                  "support": None
                }
              }
            ...
            "support": [
              {
                        ...
                        "support": [
                          {
                                    ...
                                    "support": [
                                      {
                                                ...
                                                "support": [
                                                  {
                                                    ...
                                                    "rule": {
                                                      "name": "((rela ?x ?y) (relb ?y ?z)) -> (relc ?x ?z)",
                                                      "asserted": True,
                                                      "support": None
                                                    }
                                                  }
                                        ...
                                        "rule": {
                                          "name": "((relc ?x ?y) (reld ?y ?z)) -> (rele ?x ?z)",
                                          "asserted": True,
                                          "support": None
                                        }
                                      }
                            ...
                            "rule": {
                              "name": "((rele ?x ?y) (relf ?y ?z)) -> (relg ?x ?z)",
                              "asserted": True,
                              "support": None
                            }
                          }
                ...
                "rule": {
                  "name": "((relg ?x ?y) (relh ?y ?z)) -> (reli ?x ?z)",
                  "asserted": True,
                  "support": None
                }
              }
...
class KBTest(unittest.TestCase):
    ...
    def test2(self):
        ...
        if unittest.main.verbosity > 1:
            print(' Asking if', ask1)
        answer = self.KB.kb_ask(ask1)
        explanation = self.KB.kb_explain(answer)
        self.assertEqual(str(answer[0]), "?X : felix")
        self.assertEqual(str(answer[1]), "?X : chen")
        self.assertEqual(explanation, test2_explanation)
    ...
    def test11(self):
        ...
        answer1 = KB.kb_ask(ask1)
        explanation1 = KB.kb_explain(answer1)

        self.assertTrue(answer1 is not None)
        self.assertTrue(len(answer1) > 0)
        self.assertEqual(explanation1, test11_explanation)
